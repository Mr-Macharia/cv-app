...
export const SparklesIcon = ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M19 3v4M17 5h4M12 2v4M10 4h4M8 12a4 4 0 118 0 4 4 0 01-8 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 12h.01M19 12h.01M12 5V3M12 21v-2M3.5 18.5l1.41-1.41M19.09 4.91l-1.41 1.41M3.5 5.5l1.41 1.41M19.09 19.09l-1.41-1.41" />
    </svg>
);
